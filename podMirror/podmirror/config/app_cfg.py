# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in podMirror.
...
import podmirror
from podmirror import model, lib
...
base_config.model = podmirror.model
base_config.DBSession = podmirror.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "a5fa994d-b9ff-4401-a008-b38ea2dacf32"
